...
from .logconfig import ColorFormatter  
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 20,  # Determines the number of items per page
}
...
LOGGING = {
    ...
    'formatters': {
        'verbose': {
            '()': ColorFormatter,  # Use the custom ColorFormatter
    ...
    'handlers': {
        'console': {
            ...
            'formatter': 'verbose',  # Ensure this uses your ColorFormatter
        },
        'file': {
            'level': 'INFO',
